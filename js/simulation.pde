...
var SHIP_CHART_COLOR = null;

// Missile
var ROCKET_RADIUS = 2;
var ROCKET_VELOCITY = 10;
var ROCKET_COLOR = null;
...
function setup() {
  ...
  // NOTE: Cannot use p5 methods/variables before setup
  BG_COLOR = color(8, 12, 48, FADE_LEVEL);
  PLANET_COLOR = color(255, 255, 255);//color(12, 22, 116);
  STAR_COLOR = color(168, 123, 0);
  SHIP_COLOR = color(4, 71, 107);
  LABEL_COLOR = color(209, 198, 168, FADE_LEVEL); 
  GRID_COLOR = LABEL_COLOR;
  TARGET_COLOR = color(133, 40, 40);
  SHIP_CART_COLOR = color(2, 48, 73, FADE_LEVEL);
  ROCKET_COLOR = color(100, 0, 0);
